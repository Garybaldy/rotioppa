...
<div style="min-height:400px;margin-top:10px;margin-bottom:10%;padding-bottom:0%;" class="content-text">
...
<div class="box-content">
	<div id="kontak">
		<div style="display:inline-block;">
			...
			<div class="jelas" style="font-family: 'open_sansregular';margin-bottom:5%;">
...
<?}else{?>
	<br><h3><b>Data is not found</b></h3>
<?}?>
